...
def gen_init_content(package_name: str, items: list[tuple[str, list[str]]]) -> str:
    ...
    lines.append("Run: python tools/gen_instagram_mobile_exports.py")
    lines.append("")
    lines.append(f"Public exports for insta_wizard.mobile.{package_name}.")
    lines.append('"""')
    lines.append("")
...
def main() -> None:
    ...
    parser.add_argument(
        "--root",
        type=str,
        default=os.getenv("MOBILE_PACKAGE_PATH"),
        help="Path to insta_wizard/mobile package directory",
    )
